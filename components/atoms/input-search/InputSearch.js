		...
		<div>
			<label className="relative block">
				...
				<input
					type="text"
					name="search"
					className="block bg-gradient-to-r text-md bg-opacity-25 backdrop-filter from-gray-200 to-gray-100 w-full rounded-full py-2 pl-9 pr-3 shadow-sm placeholder:font-bold placeholder:text-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1"
