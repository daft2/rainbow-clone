			...
			<form onSubmit={handleSubmit}>
				<label className="relative block">
					...
					<input
						...
						className="block bg-gradient-to-r placeholder:text-lg bg-opacity-25 backdrop-filter from-slate-200 to-slate-200 w-full rounded-full py-2 pl-9 pr-3 shadow-sm placeholder:font-bold placeholder:text-slate-400 focus:font-extrabold focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1"
